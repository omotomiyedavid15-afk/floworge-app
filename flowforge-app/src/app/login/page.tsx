  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        ...
        {/* Card */}
        <div
          className="w-full max-w-sm bg-[#1a1a1a] border border-[rgba(255,255,255,0.08)] rounded-[16px] p-8 shadow-[rgba(0,0,0,0.5)_0px_8px_32px] animate-scale-in"
        >
          <h1
          ...
          {error && (
            <div className="mb-4 px-3 py-2.5 rounded-[6px] bg-[rgba(239,68,68,0.1)] border border-[rgba(239,68,68,0.2)] text-[#f87171]" style={{ fontSize: "13px", fontWeight: 330, letterSpacing: "-0.1px" }}>
              {error}
            </div>
          )}
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span
              ...
              style={{ fontSize: "12px", fontWeight: 330, letterSpacing: "0.2px" }}
            >
              or continue with
            </span>
            <div className="flex-1 h-px bg-[rgba(255,255,255,0.08)]" />
